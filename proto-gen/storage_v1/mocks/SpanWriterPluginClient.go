...
// WriteSpanStreamingly provides a mock function with given fields: ctx, opts
func (_m *SpanWriterPluginClient) WriteSpanStreamingly(ctx context.Context, opts ...grpc.CallOption) (storage_v1.SpanWriterPlugin_WriteSpanStreaminglyClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 storage_v1.SpanWriterPlugin_WriteSpanStreaminglyClient
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) storage_v1.SpanWriterPlugin_WriteSpanStreaminglyClient); ok {
		r0 = rf(ctx, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(storage_v1.SpanWriterPlugin_WriteSpanStreaminglyClient)
		}
	}
